...
import static com.skyfree.flashalert.utils.Utils.DISABLE_WHEN_BATTERY_BELOW_PERCENT;
...
public class TimePickerDialog extends DialogFragment implements
    ...
    public void setTitleCustom(String txt){
//        mTvCustom = (TextView) view.findViewById(R.id.tv_custom);
//        mTvCustom.setText(txt);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mViewCustom = inflater.inflate(R.layout.mdtp_time_title_view_v2, container, false);
        ...
        mTvCustom = view.findViewById(R.id.txt_AAAA);
        if(com.skyfree.flashalert.utils.Utils.TYPE.equals(com.skyfree.flashalert.utils.Utils.ON)){
            mTvCustom.setText(getString(R.string.dnd_start));
        }else if(com.skyfree.flashalert.utils.Utils.TYPE.equals(com.skyfree.flashalert.utils.Utils.OFF)){
            mTvCustom.setText(getString(R.string.dnd_end));
        }
